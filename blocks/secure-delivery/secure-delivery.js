...
function appendLoginForm() {
  if (document.querySelector('.secure-delivery-container .login-form-wrapper')) {
    return;
  }
  const loginForm = `
  ...
  document.querySelector('.secure-delivery-container')?.prepend(formWrapper);
...
export default function decorate(block) {
  ...
  if (document.querySelector('.secure-delivery-container')?.getAttribute('data-include-principal-form') === 'true') {
    appendLoginForm();
  }
